...
// ============================================================================
// ORDER VENDOR SERVICE (REPAIRED & ROBUST VERSION v3 — retry wired up)
// ============================================================================
...
export async function selectVendor(
  ...
  // 🟡 RACE CONDITION FIX: Isolation level dinaikkan ke Serializable, dan
  // dibungkus withSerializableRetry karena Postgres akan menolak salah satu
  // dari dua transaksi Serializable yang bentrok (P2034) — itu perilaku
  // normal yang harus di-retry otomatis, bukan langsung dilempar ke user.
